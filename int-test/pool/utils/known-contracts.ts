...
import { IUniswapV3Factory__factory } from '../../../typechain-types';
import { IUniswapV3Pool__factory } from '../../../typechain-types';
import { IWETH9__factory, IUSDC__factory } from '../../../typechain-types';

export const wethContract = (signerOrProvider?: ContractRunner) =>
  IWETH9__factory.connect(`0xC02aaA39b223FE8D0A0e5C4F27eAD9083C756Cc2`, signerOrProvider);

export const usdcContract = (signerOrProvider?: ContractRunner) =>
  IUSDC__factory.connect(`0xA0b86991c6218b36c1d19D4a2e9Eb0cE3606eB48`, signerOrProvider);

export const uniswapFactoryContract = (signerOrProvider?: ContractRunner) =>
